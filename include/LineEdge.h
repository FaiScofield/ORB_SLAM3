...
class EdgeLineProjectXYZOnlyPoseNew : public g2o::BaseUnaryEdge<1, float, g2o::VertexSE3Expmap>
{
public:
    ...
    virtual void computeError()
    {
        ...
        Eigen::Vector3d obs = Func;    //线段所在直线参数
        Eigen::Vector2d proj = cam_project(v1->estimate().map(Xw));    //MapLine端点在像素平面上的投影
    ...
    void set_Func(const Eigen::Vector3d& func)
    {
        Func = func;
    }
...
class EdgeLineProjectXYZOnlyPose : public g2o::BaseUnaryEdge<3, g2o::Vector3d, g2o::VertexSE3Expmap>
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW;
