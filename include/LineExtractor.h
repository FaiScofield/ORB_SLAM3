...
public:
    ...
    void operator()( cv::InputArray image, cv::InputArray mask, std::vector<cv::line_descriptor::KeyLine>& keylines, cv::OutputArray descriptors, std::vector<Eigen::Vector3d> &lineVec2d);
