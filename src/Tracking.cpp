...
void Tracking::Track()
{
    ...
    if (mState != NO_IMAGES_YET)
    {
        ...
        {
            LOGW("id last: " << mLastFrame.mnId << ", time: " << mLastFrame.mTimeStamp
...
bool Tracking::TrackWithOdometry()
{
    ...
    ODOM::Point dodom_o2o1 = mCurrentFrame.mOdom + ODOM::invOdom(mLastFrame.mOdom);
