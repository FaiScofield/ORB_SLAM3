 ...
 *
 * Copyright (C) 2017-2020 Carlos Campos, Richard Elvira, Juan J. G??mez Rodr??guez, Jos?? M.M.
 * Montiel and Juan D. Tard??s, University of Zaragoza. Copyright (C) 2014-2016 Ra??l Mur-Artal,
 * Jos?? M.M. Montiel and Juan D. Tard??s, University of Zaragoza.
 *
            ...
            if (!LastFrame.mvbOutlier[i]) {
                ...
                if (CurrentFrame.Nleft != -1) {
                    ...
                    if (bForward)
                        ...
                        vIndices2 =
                            CurrentFrame.GetFeaturesInArea(uv.x, uv.y, radius, 0, nLastOctave, true);
                    else
                        vIndices2 =
                            CurrentFrame.GetFeaturesInArea(uv.x, uv.y, radius, nLastOctave - 1,
                                                           nLastOctave + 1, true);
        ...
        if (pMP) {
            if (!pMP->isBad() && !sAlreadyFound.count(pMP)) {
                ...
                const vector<size_t> vIndices2 =
                    CurrentFrame.GetFeaturesInArea(uv.x, uv.y, radius, nPredictedLevel - 1,
                                                   nPredictedLevel + 1);
